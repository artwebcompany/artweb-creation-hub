...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    results: 'Implementasi sistem telah meningkatkan efisiensi operasional sebesar
65% dengan mengurangi kesalahan administratif secara drastis. Tingkat okupansi villa meningkat 40% berkat kemudahan manajemen multi-channel booking. Feedback pelanggan menunjukkan peningkatan kepuasan sebesar 4.8/5 berkat responsivitas sistem dan kemudahan penggunaan portal pelanggan.',
    testimonial: {
  ...
  },
  {
    ...
    results: 'Website telah menjadi showcase efektif yang menghasilkan peningkatan inquiry sebesar
200% dalam 4 bulan pertama. Rata-rata waktu yang dihabiskan pengunjung di website mencapai 7 menit, dengan tingkat bounce rate rendah sebesar 25%. Fitur virtual tour menjadi yang paling populer dengan 65% pengunjung mengeksplorasi fitur ini.',
    testimonial: {
